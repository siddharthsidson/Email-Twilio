...
Mail-listener-fixed2 library for node.js based on fixes from forks at mail-listener2. Get notification when new email arrived to inbox or when message metadata (e.g. flags) changes externally. Uses IMAP protocol.
...
Run npm install mail-listener-fixed2 --save
